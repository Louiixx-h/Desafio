...
public class RepositoryDataSource extends PageKeyedDataSource<Integer, ItemRepository> {
    ...
    @Override
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull LoadInitialCallback<Integer, ItemRepository> callback) {
        RetrofitClient.getInstance()
                .findAllReposritories(TOPIC, SORT, FIRST_PAGE)
    ...
    @Override
    public void loadBefore(@NonNull LoadParams<Integer> params, @NonNull LoadCallback<Integer, ItemRepository> callback) {
        RetrofitClient.getInstance()
                .findAllReposritories(TOPIC, SORT, params.key)
                .enqueue(new Callback<RepositorieResponse>() {
                    @Override
                    public void onResponse(Call<RepositorieResponse> call, Response<RepositorieResponse> response) {
    ...
    @Override
    public void loadAfter(@NonNull LoadParams<Integer> params, @NonNull LoadCallback<Integer, ItemRepository> callback) {
        RetrofitClient.getInstance()
                .findAllReposritories(TOPIC, SORT, params.key)
                .enqueue(new Callback<RepositorieResponse>() {
                    @Override
